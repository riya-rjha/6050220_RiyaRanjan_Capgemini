...
public class Employee {
	...
	@Autowired // works like this also for address, but rest eid, ename and esalary are set to
				...
				// default constructor is removed, forcefully parameterized constructor is being
				// called, if default constructor does not exist, then setter is used to initialize it
...
//	But for Autowiring, this is not the right place, right it above constructor, else NULL
	...
	public Set<Integer> getMobileNoSet() {
		return mobileNoSet;
	}

	public void setMobileNoSet(Set<Integer> mobileNoSet) {
		this.mobileNoSet = mobileNoSet;
	}
...
//	@Autowired // by default it is byType
	...
	public String toString() {
		return "Employee [eid=" + eid + ", ename=" + ename + ", esalary=" + esalary + ", address="
				+ (address == null ? "NULL" : address.toString()) + ", mobileNoSet=" + mobileNoSet + "]";
	}
